...
public class Main {
    ...
    public static void modifyItem() {
        //Commented code will work with the private version of the method in GroceryList
    ...
    public static void processArrayList() {     //Three ways of copying an Array
        ArrayList<String> newArray = new ArrayList<String>();
        newArray.addAll(groceryList.getGroceryList());

        ArrayList<String> nextArray = new ArrayList<String>(groceryList.getGroceryList());

        //This will convert from list to array.
